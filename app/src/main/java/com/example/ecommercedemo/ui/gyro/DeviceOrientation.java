    ...
    SensorEventListener sensorEventListener = new SensorEventListener() {
        ...
        public void onSensorChanged(SensorEvent event) {
            ...
            if (mGravity != null && mGeomagnetic != null) {
                Log.d("DeviceOrientation", "onSensorChanged mGravity "+mGravity[0]+", "+mGravity[1]+", "+mGravity[2]);
                Log.d("DeviceOrientation", "onSensorChanged mGeomagnetic "+mGeomagnetic[0]+", "+mGeomagnetic[1]+", "+mGeomagnetic[2]);
                float R[] = new float[9];
                float I[] = new float[9];
                ...
                if (success) {
                    ...
                    onRoll(averageRoll);
                    Log.d("DeviceOrientation", "averagePitch "+averagePitch);
                    Log.d("DeviceOrientation", "averageRoll "+averageRoll);
                    Log.d("DeviceOrientation", "orientationz "+orientation);
                }
            }
        }
